const translations = {
  en: {
    ...
    1200: 1200,
    12: 12,
    storyTitle: "Read Our Success Story for Inspiration",
    storyDesc:
      "The beginning was to provide basic services such as registration and pre-qualification services for companies, in addition to management consulting. Thanks to its commitment to providing outstanding services, Bariq Al Shati has been able to build a strong reputation in the Saudi market and become one of the leading consulting companies. Today, Bariq Al Shati is one of the trusted business consulting firms in Saudi Arabia, and it continues to provide high-quality services that contribute to achieving the goals of its clients and enhancing their competitiveness in the market.",
    statsOne: "Years Of Experience",
    statsTwo: "Happy Clients",
    statsThree: "Completed Projects",
    ...
    qusOne:
      "What services does your company provide in the field of consulting?",
    answerOne:
      "We offer a variety of consulting services, including growth strategies, operational efficiency improvement, change management, market analysis, technology consulting, and business development.",
    qusTwo:
      "How can your company help me improve operational efficiency and increase productivity?",
    answerTwo:
      "We analyze your company's current processes, then provide innovative solutions to improve workflow, reduce costs, and increase productivity using advanced tools and technologies.",
    qusThree:
      "Do you provide ongoing support after the consultations are completed?",
    answerThree:
      "Yes, we provide ongoing support to ensure strategies are implemented effectively, monitor work outcomes, and adjust plans when needed to achieve the best results.",
    qusFour: "Do you help companies expand into new markets?",
    answerFour:
      "Yes, we provide strategic consulting for entering new markets. We study target markets, analyze competition, and develop marketing plans that help you expand safely and effectively.",
    qusFive:
      "Do you provide customized consultations based on the type and size of my company?",
    answerFive:
      "Yes, we offer customized consulting tailored to your company’s unique needs, whether it’s a startup or a large enterprise, to ensure that the solutions we provide align with your goals and market conditions.",
    fName: "First Name",
    lName: "Last Name",
    email: "Email",
    phone: "Phone",
    message: "Message",
    optionTwo: "Registration Services",
    optionThree: "Pre-Qualification Services",
    optionFour: "Management Consultation",
    optionFive: "Company Profile Design",
    optionSix: "Web Design and Development",
    footerFirst: "Quick links",
    footerSecond: "Social Profile",
    send: "Send",
  ...
  ar: {
    ...
    1200: "١٢٠٠",
    12: "١٢",
    storyTitle: "اقرأ قصة نجاحنا للإلهام",
    storyDesc:
      "كانت البداية بتقديم خدمات أساسية مثل خدمات التسجيل والتأهيل المسبق للشركات، إضافة إلى استشارات الإدارة.بفضل التزامها بتقديم خدمات متميزة، تمكنت شركة بارق الشاطئ من بناء سمعة قوية في السوق السعودي، وأصبحت واحدة من الشركات الرائدة في مجال الاستشارات. اليوم، تعد بارق الشاطئ من الشركات الموثوقة في مجال استشارات الأعمال في السعودية، وهي تواصل تقديم خدماتها عالية الجودة التي تساهم في تحقيق أهداف عملائها وتعزيز تنافسيتهم في السوق.",
    ...
    qusOne: "ما هي الخدمات التي تقدمها شركتكم في مجال الاستشارات؟",
    answerOne:
      "نحن نقدم مجموعة متنوعة من الخدمات الاستشارية ، بما في ذلك استراتيجيات النمو ، وتحسين الكفاءة التشغيلية ، وإدارة التغيير ، وتحليل السوق ، والاستشارات التكنولوجية ، وتطوير الأعمال",
    qusTwo:
      "كيف يمكن لشركتكم مساعدتي في تحسين الكفاءة التشغيلية وزيادة الإنتاجية؟",
    answerTwo:
      "قوم بتحليل العمليات الحالية لشركتك ، ثم نقدم حلولا مبتكرة لتحسين سير العمل وتقليل التكاليف وزيادة الإنتاجية باستخدام الأدوات والتقنيات المتقدمة.",
    qusThree: "هل تقدمون دعما مستمرا بعد الانتهاء من المشاورات؟",
    answerThree:
      "نعم ، نحن نقدم الدعم المستمر لضمان تنفيذ الاستراتيجيات بشكل فعال ، ومراقبة نتائج العمل ، وتعديل الخطط عند الحاجة لتحقيق أفضل النتائج",
    qusFour: "هل تساعدون الشركات على التوسع في أسواق جديدة؟",
    answerFour:
      "نعم ، نحن نقدم الاستشارات الاستراتيجية لدخول أسواق جديدة. نحن ندرس الأسواق المستهدفة ونحلل المنافسة ونضع خططا تسويقية تساعدك على التوسع بأمان وفعالية",
    qusFive: "هل تقدمون استشارات مخصصة بناء على نوع وحجم شركتي؟",
    answerFive:
      "نعم ، نحن نقدم استشارات مخصصة مصممة خصيصا لتلبية الاحتياجات الفريدة لشركتك ، سواء كانت شركة ناشئة أو مؤسسة كبيرة ، لضمان توافق الحلول التي نقدمها مع أهدافك وظروف السوق",
    fName: "الاسم الاول",
    lName: "الاسم الاخير",
    email: "البريد الالكتروني",
    phone: "رقم الهاتف",
    message: "رسالتك",
    optionTwo: "خدمات التسجيل",
    optionThree: "خدمات التأهيل المسبق",
    optionFour: "المشاورات الإدارية",
    optionFive: " تصميم ملف الشركة",
    optionSix: " تصميم وتطوير المواقع الإلكترونية",
    footerFirst: "روابط سريعة",
    footerSecond: "حساباتنا الاجتماعية",
    send: "ارسال",
...
function changeLanguage(language) {
  ...
  // تجنب التبديل إذا كانت اللغة الحالية هي نفسها اللغة المختارة
  ...
  if (language === "ar") {
    ...
    languageButton.src = "images/en.png"; // تغيير الصورة إلى العربية
  } else {
...
if (
  savedLanguage &&
  savedLanguage !== document.documentElement.getAttribute("lang")
) {
  changeLanguage(savedLanguage);
} else {
  // إذا لم تكن اللغة مخزنة أو إذا كانت اللغة المخزنة هي نفس اللغة الحالية
  // يمكن أن تضيف حالة أخرى هنا إذا أردت أن تحدد اللغة الافتراضية
  localStorage.setItem("language", "en"); // تعيين الإنجليزية كافتراضي إذا لم تكن موجودة
}
